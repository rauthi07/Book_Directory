...
b2 = Button(root, text='Search Entry', width=12, command=front_search)
b2.grid(row=3, column=3)

b3 = Button(root, text='Add Entry', width=12, command=front_add)
b3.grid(row=4, column=3)

b4 = Button(root, text='Update', width=12, command=front_update)
b4.grid(row=5, column=3)

b5 = Button(root, text='Delete', width=12, command=front_delete)
